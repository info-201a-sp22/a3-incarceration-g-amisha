...
As of 2018, there have been `r summary_info$total_incarcerations`. This number may include repeat offenders. `r summary_info$state_highest` has the highest number of incarcerations as of 2018. As for Black incarcerations, the highest increase was in `r summary_info$highest_increase` while biggest fall occurred the year `r summary_info$highest_decrease`. 
...
**5. How many features (columns) are in the data?** <br> There are `r summary_info$number_rows` features in the data.
